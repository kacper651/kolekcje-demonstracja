...
public class PersonConsoleApp {
	...
	private static final String MENU = 
			...
			"6 - Zapisz dane do kolekcji \n" +
			"7 - Wyświetl dane z kolekcji \n" +
			"8 - Usuń dane z kolekcji    \n" +
			"0 - Zakończ program        \n";
		...
		while (true) {
			...
			try {
				...
				case 5: {
					...
					case 6: {
						operations.addPersonToCollections(currentPerson);//demonstracja dodawania elementow do kolekcji
						break;
					}
					case 7: {
						operations.displayPeople();//demonstracja wyświetlania elementów w kolekcji
						break;
					}
					case 8: {
						String first_name = UI.enterString("Podaj imię usuwanej osoby: ");
						String last_name = UI.enterString("Podaj nazwisko usuwanej osoby: ");
						currentPerson = new Person(first_name, last_name);
						operations.removeFromCollection(currentPerson);
						break;
					}
				case 0:
